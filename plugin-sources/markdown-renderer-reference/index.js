 ...
 * - Communication with backend via modux API
 */
...
(function() {
  ...
  function insertHeading(level) {
    ...
    if (headingMatch) {
      ...
      editor.value = text.substring(0, lineStart) + heading + text.substring(lineStart);
      editor.setSelectionRange(lineStart + heading.length, lineStart + heading.length);
    }
  ...
  function insertList() {
    ...
    const listItem = '- ';
    editor.value = text.substring(0, lineStart) + listItem + text.substring(lineStart);
    editor.focus();
    editor.setSelectionRange(lineStart + listItem.length, lineStart + listItem.length);
